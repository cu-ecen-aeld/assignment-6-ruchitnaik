...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-ruchitnaik.git;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
SRCREV = "39195180cccb1e4decd6f0cdf2a009e9b1dc9200"
...
#References class which handles install script
inherit update-rc.d
